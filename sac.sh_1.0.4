...
do 
    ...
    case $option in 
	    ...
	    echo -e "重启终端或者输入bash sac.sh重新进入脚本"
            break ;;
        *) 
            echo -e "\033[0;36m居然不听话，快回去\033[0m\n"
            ;;
    esac
done 
